        ...
        const USER_API_MODULES = [
            ...
            // Folder: Billing & Plans
            {
                ...
                endpoints: [
                    ...
                    { method: 'POST', title: 'Purchase Plan', url: '/api/user/plans/purchase', description: 'Subscribe to a plan.', body: { plan_id: 1, method: 'stripe', payment_type: 'subscription' }, badge: 'Auth Required' },
            ...
            // Folder: Support
            {
                ...
                endpoints: [
                     ...
                     { method: 'POST', title: 'Create Ticket', url: '/api/user/support', description: 'Open a new support ticket.', body: { subject: 'Help needed', message: '...' }, badge: 'Auth Required' }
                ]
            }
        ];
